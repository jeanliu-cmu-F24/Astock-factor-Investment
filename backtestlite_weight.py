...
class Backtestlite_weight(object):
    ...
    def getQuantileWeight(self, choose_quantile):
        ...
        if choose_quantile==1.:
            weight[(self.rank <= ((choose_quantile * 1.0) / (self.quantile*2))) & (self.rank > ((choose_quantile - 1) / (self.quantile*2)))]=1
            weight = weight.div(weight.sum(axis = 1)*4/3, axis = 0)
            weight[(self.rank <= ((choose_quantile + 1) / (self.quantile*2))) & (self.rank > ((choose_quantile * 1.0) / (self.quantile*2)))]=1
            weight[(self.rank <= ((choose_quantile + 1) / (self.quantile*2))) & (self.rank > ((choose_quantile * 1.0) / (self.quantile*2)))] = weight[(self.rank <= ((choose_quantile + 1) / (self.quantile*2))) & (self.rank > ((choose_quantile * 1.0) / (self.quantile*2)))].div((weight.sum(axis = 1)-0.75)*4, axis = 0)

        elif choose_quantile== self.quantile:
            weight[(self.rank <= ((choose_quantile * 2.0) / (self.quantile*2))) & (self.rank > ((choose_quantile* 2.0 - 1) / (self.quantile*2)))]=1
            weight = weight.div(weight.sum(axis = 1)*4/3, axis = 0)
            weight[(self.rank <= ((choose_quantile * 2.0 - 1) / (self.quantile*2))) & (self.rank > ((choose_quantile * 2.0 - 2) / (self.quantile*2)))]=1
            weight[(self.rank <= ((choose_quantile * 2.0 - 1) / (self.quantile*2))) & (self.rank > ((choose_quantile * 2.0 - 2) / (self.quantile*2)))] = weight[(self.rank <= ((choose_quantile * 2.0 - 1) / (self.quantile*2))) & (self.rank > ((choose_quantile * 2.0 - 2) / (self.quantile*2)))].div((weight.sum(axis = 1)-0.75)*4, axis = 0)
